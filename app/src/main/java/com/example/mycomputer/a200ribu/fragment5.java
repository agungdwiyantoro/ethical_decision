...
public class fragment5 extends Fragment  implements View.OnClickListener, ViewPager.OnPageChangeListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        desc.loadUrl("file:///android_asset/virtue.html");
    ...
    public static class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            args.putInt(ChildFragment.FRAGMENT_POSITION_KEY, 4);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new fragment5.MyAdapter(getChildFragmentManager()));
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        if(seekBar.getId()==R.id.seekBar_tq1){
            Toast.makeText(getActivity(), ""+ seekBar.getProgress(),
                    Toast.LENGTH_SHORT).show();
            editor.putInt(f5q1, seekBar.getProgress());
        }
        else if(seekBar.getId() == R.id.seekBar_tq2){
            Toast.makeText(getActivity(), ""+ seekBar.getProgress(),
                    Toast.LENGTH_SHORT).show();
            editor.putInt(f5q2, seekBar.getProgress());
        }
