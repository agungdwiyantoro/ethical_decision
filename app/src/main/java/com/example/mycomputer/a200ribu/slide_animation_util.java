...
public class slide_animation_util {
    ...
    public static void slideInFromLeft(Context context, View view) {
        runSimpleAnimation(context, view, R.anim.act_slide_from_left);
    }
    ...
    public static void slideOutToLeft(Context context, View view) {
        runSimpleAnimation(context, view, R.anim.act_tran_slide_to_left);
    }
    ...
    public static void slideInFromRight(Context context, View view) {
        runSimpleAnimation(context, view, R.anim.act_slide_from_right);
    }
    ...
    public static void slideOutToRight(Context context, View view) {
        runSimpleAnimation(context, view, R.anim.act_trans_slide_to_right);
    }
